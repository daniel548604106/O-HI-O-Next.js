...
const RefundPolicy = () => {
  return (
    <div className="mx-auto max-w-1200px space-y-2 px-15px">
      <h2 className="text-md sm:text-lg font-semibold">退款換貨須知</h2>
      <p>
      ...
      <p>
        若申請逾時或不符合 O.HI.O
        退貨政策條件範圍，設計師有權拒絕退貨，請在提交申請前與設計師溝通。
      </p>
      <h3 className="text-md sm:text-lg font-semibold">
      ...
      <h3 className="text-md sm:text-lg font-semibold">退款流程</h3>
      ...
      <h3 className="text-md sm:text-lg font-semibold"> 設計館提供換貨服務</h3>
      <ul>
        ...
        <li>
          設計師在收到商品、確認商品狀態後，將於 7 個工作天將指定更換商品寄出
        </li>
      </ul>
    </div>
  );
