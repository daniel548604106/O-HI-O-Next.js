...
const SideMenu = () => {
  ...
  const CtaBtn = () => (
    <div
      className={`${isSideMenuOpen && "translate-x-0"} fixed z-50 top-60px -translate-x-full  left-0 ease-in-out overflow-y-auto delay-150 w-300px transition-all duration-200
