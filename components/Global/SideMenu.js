...
const SideMenu = () => {
  ...
  const CtaBtn = () => (
    <div
      className={`${isSideMenuOpen && "translate-x-full"} fixed z-50 top-0 left-0  -left-full overflow-y-auto max-w-300px  max-h-screen  w-full overflow-hidden transition-all duration-200
