...
const FAQ = () => {
  ...
  return (
    <div className="text-center">
      <h1 className="mb-30px text-center text-xl  text-light-blue">
        設計館常見問答
      </h1>
      <div
        onClick={() => handleChangeActive(0)}
        className="cursor-pointer p-15px bg-bg-white"
      >
        申請設計館後，何時會收到結果通知？如何查詢審核結果？
      </div>
      {active === 0 && (
        <p className="px-15px py-30px text-md leading-normal text-left ">
          為了維護設計館一致且良好的品質，你的設計館申請資料將由 O.HI.O
          團隊進行審核，並於 10 個工作天（不含假日）左右發出結果通知。
          <br />
          若你的申請通過審核，O.HI.O 會直接寄出開館通知信。
          <br />
          未通過審核，仍會收到結果通知，請重新審視你的商品是否符合 O.HI.O
          商品販售政策。
          <br />
